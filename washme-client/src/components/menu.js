export const menuItems = [
    ...
    {
        id: 6,
        label: "menuitems.items.text",
        icon: "uil-store",
        subItems: [
            {
                id: 7,
                label: "menuitems.items.list.itemlist",
                link: "/product/productlist",
                parentId: 6
            },
            {
                id: 8,
                label: "menuitems.items.list.categories",
                link: "/productcategory/productcategory",
                parentId: 6
            },
            {
                id: 9,
                label: "menuitems.items.list.modifiers",
                link: "/ecommerce/orders",
                parentId: 6
            },
            {
                id: 10,
                label: "menuitems.items.list.discount",
    ...
    {
        id: 11,
        label: "menuitems.inventorymanagement.text",
        icon: "uil-calender",
        link: "/calendar"
    },
    {
        ...
        subItems: [
            {
                id: 13,
                label: "menuitems.employees.list.employeelist",
                link: "/employee/employeelist",
                parentId: 12
            },
            {
                id: 14,
                label: "menuitems.employees.list.accessrights",
                link: "/employerole/employeerolelist",
                parentId: 12
            }
        ]
    },
